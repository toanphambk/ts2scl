import { Input, Instance, Output, SCLFB, SCLFn, SCLType } from '../core/types/decorators';
import { Temp, WORD, REAL, TIME, STRING } from '../core/types/decorators';
import { BOOL, INT } from '../core/types/types';
