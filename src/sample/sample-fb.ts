import { SCLFB, Static, Input, Output, Retain, SCLType, SCLArray } from '../core/types/decorators.js';
import { BOOL, INT, WORD, dim } from '../core/types/types.js';
import { DriveCalculateSpeed, DriveControl, DriveCalcSpeedInput, DriveCalcSpeedOutput, DriveControlInput, DriveControlOutput } from './sample-fc.js';
...
export class DriveController {
    ...
    public exec(
        ...
        // Calculate speed using DriveCalculateSpeed function
        calculatedSpeed = DriveCalculateSpeed.exec(
            calcSpeedInput,
            calcSpeedOutput
        );
